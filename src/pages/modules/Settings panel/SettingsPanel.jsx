      ...
      {activeTab === "Support" && (
        <Box sx={{ background: "#fff", borderRadius: 3, p: 2, boxShadow: "0 0 6px rgba(0,0,0,0.1)" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2, position: "relative" }}>
            ...
            <Box onClick={() => setCommentsFilterOpen(!commentsFilterOpen)}
              sx={{padding: "6px 12px", borderRadius: 20, border: "1px solid #4CAF50", fontSize: 13, cursor: "pointer", display: "flex", alignItems: "center", gap: 1, background: "#fff"}}
            >
              {selectedFilter}
            ...
            {commentsFilterOpen && (
              <Box sx={{position: "absolute", top: "110%", right: 0, width: 180, background: "#fff", borderRadius: 3, boxShadow: "0 4px 12px rgba(0,0,0,0.15)", p: 1.5, zIndex: 20}}
              >
                {/* Arrows */}
                ...
                {[
                  ...
                  <Box key={item.label}
                    ...
                    sx={{display: "flex", justifyContent: "space-between", alignItems: "center", background: item.color, borderRadius: 2, px: 1.5, py: 0.8, mb: 1, fontSize: 13, cursor: "pointer"}}
                  >
