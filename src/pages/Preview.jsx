...
import { ArrowBack, Monitor, PhoneAndroid, Tablet, ScreenRotation } from "@mui/icons-material";
...
const Preview = () => {
  ...
  const rawHTML =
    ...
    `<div style="padding:20px;font-family:Arial">
      ...
      <p>Random paragraph text for preview testing...</p>
    </div>`;
  ...
  return (
    <Box sx={{ height: "100vh", bgcolor: "#f4f6f8" }}>
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          {device !== "desktop" && (
            <Tooltip title="Rotate">
              <IconButton onClick={() => setOrientation(o => (o === "portrait" ? "landscape" : "portrait"))}><ScreenRotation /></IconButton>
            </Tooltip>
          )}
        </Box>
      </Box>
      ...
      <Box ref={containerRef} sx={{ height: "calc(100vh - 64px)", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden" }}>
        <Box
          sx={{
            width, height, bgcolor: "#fff", overflow: "hidden", boxShadow: 6,
            borderRadius: device === "desktop" ? 3 : device === "tablet" ? 6 : 8,
            border: device === "desktop" ? "10px solid #222" : device === "tablet" ? "12px solid #333" : "14px solid #111",
            transform: `scale(${autoFitScale})`, transformOrigin: "center"
          }}
        >
